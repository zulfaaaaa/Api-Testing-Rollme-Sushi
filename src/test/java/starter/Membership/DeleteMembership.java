...
public class DeleteMembership {
    protected static String url ="http://128.199.206.32:8000/api/v1/admin/membership/67";
    public String token ="";
    ...
    public void iReceivedTheToken(){
        ...
        restAssuredThat(response -> response.body("'meta'.'message'", equalTo("Membership deleted")));
    }
}
