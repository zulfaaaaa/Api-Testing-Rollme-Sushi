...
public class SearchItemByName {
    protected static String url ="http://128.199.206.32:8000/api/v1/cashier/order/search?name=Taro";
    public String token ="";
    ...
    @Step("cashier sends a GET request to the category endpoint with name item valid for search item")
    ...
    @Step("the item with the given name has been successfully displayed")
    public void iReceivedTheToken(){
       ...
       // restAssuredThat(response -> response.body("'data'.'name'", equalTo("<[Taro, Taro]>")));
    }
}
